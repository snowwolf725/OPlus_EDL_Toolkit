...
export function useAdvancedPanelEventHandler(imgSavingPath, isDebug) {
    ...
    const cmdList = ref([
        { id: 1, label: '1. Send Loader', value: 'loader' },
        { id: 2, label: '2. Send Digest', value: 'digest' },
        { id: 3, label: '3. Transfercfg', value: 'transfercfg' },
        { id: 4, label: '4. Verify', value: 'verify' },
        { id: 5, label: '5. Send Sig', value: 'sig' },
        { id: 6, label: '6. Sha256init', value: 'sha256init' },
        { id: 7, label: '7. Configure', value: 'configure' },
        { id: 8, label: 'Nop', value: 'nop' },
        { id: 9, label: 'Getstorageinfo', value: 'getstorageinfo' },
        { id: 10, label: 'Power', value: 'power' },
        { id: 11, label: 'Read', value: 'read' },
        { id: 12, label: 'Program', value: 'program' },
        { id: 13, label: 'Erase', value: 'erase' },
        { id: 14, label: 'Patch', value: 'patch' },
    ]);
    ...
    async function runCommand() {
        ...
        cmdOutput.value = await invoke("run_command", {
            cmdType: selectedCmd.value,
            path: imgSavingPath.value,
            loader: loader,
            digest: digest,
            sig: sig,
    ...
    async function handleSelectCmdChange() {
        ...
        } else if (selectedCmd.value == "configure") {
